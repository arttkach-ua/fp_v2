        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <!--DOCUMENTS-->
                    <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownDocuments" role="button" data-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">
                    <fmt:message key="navbar.documents" />
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="controller?action=ordersList"><fmt:message key="navbar.orders" /></a>
                        <a class="dropdown-item" href="controller?action=invoiceList"><fmt:message key="navbar.invoices" /></a>
                    </div>
                    </li>
                    <li class="nav-item">
